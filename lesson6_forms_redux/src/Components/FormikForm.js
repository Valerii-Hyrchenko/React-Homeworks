...
export const FormikFormSignUp = () => {
    ...
    return (
        <Container>
            ...
            >
                <span style={{ color: "#FFF"}}>formik</span>
                ...
                <InputWrapper>
                    ...
                    placeholder="John"
                    />
                    {touched.name && errors.name ? <ErrorMessage>Error: {errors.name}</ErrorMessage> : null}
                </InputWrapper>
                ...
                <InputWrapper>
                    ...
                    placeholder="Snow"
                    />
                    {touched.surname && errors.surname ? <ErrorMessage>Error: {errors.surname}</ErrorMessage> : null}
                </InputWrapper>
                ...
                <InputWrapper>
                    ...
                    />
                    {touched.email && errors.email ? <ErrorMessage>Error: {errors.email}</ErrorMessage> : null}
                </InputWrapper>
                ...
                <InputWrapper>
                    ...
                    />
                    {touched.password && errors.password ? <ErrorMessage>Error: {errors.password}</ErrorMessage> : null}
                </InputWrapper>
